...
$seedUsers = [
    ...
    // password_hash = '' → Erst-Login ohne Passwort, Nutzer muss beim ersten Login ein Passwort festlegen
...
$stmtU = $pdo->prepare(
    "INSERT INTO users (id, username, {$nameCol}, email, password_hash)
     ...
     ON DUPLICATE KEY UPDATE
       ...
       email     = VALUES(email),
       -- Passwort nur setzen wenn noch keines gesetzt ist, oder der Seed-Wert nicht leer ist
       password_hash = IF(
